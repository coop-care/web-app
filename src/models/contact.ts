...
export class Contact extends Base {
  ...
  static readonly professionTypes = ["generalPractitioner", "pharmacy", "nursingService", "medicalSupplyStore", "physicalTherapy", "occupationalTherapy", "hospital", "curator", "midwife", "mealsOnWheels", "dayCareCenter"]
